...
export const WORLD_LOCATIONS: RegionDirectory[] = [
  ...
  },
  {
    ...
    categories: [
      ...
      { heading: 'Ruins', items: ['Old Bellroot Site', 'First Root Chamber', 'Lost Grove', 'Triumvirate Chapel', 'The Bound Chamber'] },
      { heading: 'Taverns', items: ['The Quiet Bell', 'Root & Stone', 'The Low Fire'] },
      { heading: 'Landmarks', items: ["Watcher's Hill", 'The Gorge', 'The Hollow Vale', 'The Bramble Hills'] },

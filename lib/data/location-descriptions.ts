...
// Every location in the Everloop has a distinct, hand-crafted
// description. Cross-references to nearby places are included
// where proximity, shared history, or trade connections exist.
// ═══════════════════════════════════════════════════════════════

export const LOCATION_DESCRIPTIONS: Record<string, string> = {

  // ─── THE DEYUNE STEPS — Nomadic Vastlands ──────────────────
  ...
  // ─── THE ASHEN SPINE — Volcanic Chain ──────────────────────
  ...
  // ─── VIRELAY COASTLANDS — Fractured Shore ─────────────────
  ...
  // ─── VARNHALT FRONTIER — Rough Feudal Edge ────────────────
  ...
  // ─── LUMINOUS FOLD — Over-Stabilized Zone ─────────────────
  ...
  // ─── THE DROWNED REACH — Submerged Ruins ──────────────────

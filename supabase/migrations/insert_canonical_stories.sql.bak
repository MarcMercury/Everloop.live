...
BEGIN
    ...
    IF admin_id IS NULL THEN
        RAISE EXCEPTION 'No admin user found. Please ensure an admin user exists.';
    END IF;
...
And no one —not even the Vaultkeepers —knows what...',
        '{"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Full story content available in content_text field."}]}]}'::jsonb,

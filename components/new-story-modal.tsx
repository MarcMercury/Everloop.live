...
const SCOPE_OPTIONS: ScopeOption[] = [
  {
    ...
    description: 'Heavy lore. Epic scope. The kind of story that uncovers what the world has been hiding.',
  ...
  },
  {
    ...
    description: 'A complete story with beginning, middle, and end. Every tale moves the world forward.',
  ...
  },
  {
    ...
    description: 'A vignette, conversation, or atmospheric fragment. Even small moments carry weight here.',
